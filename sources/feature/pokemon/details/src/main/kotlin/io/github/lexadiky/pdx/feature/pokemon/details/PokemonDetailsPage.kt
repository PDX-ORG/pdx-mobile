...
import io.github.lexadiky.pdx.library.uikit.util.createColorSchemeFromColor
import io.github.lexadiky.pdx.library.uikit.util.scroll.LocalPrimeScrollState
import io.github.lexadiky.pdx.library.uikit.widget.PagerDotIndicator
        ...
        if (isLoaded) {
            ...
            Box {
                Column {
                    HorizontalPager(
                        state = pagerState,
                        pageCount = state.availableVarieties
                    ) { page ->
